package com.leeson.ddd.model;

import android.opengl.Matrix;
import android.util.Log;

import com.leeson.ddd.animation.Animation;
import com.leeson.ddd.animation.Joint;
 ...
 * its own {@link com.leeson.ddd.animation.Animator} instance which can be used to apply animations to
 * this entity.
 *
 * @author andresoviedo
 */
